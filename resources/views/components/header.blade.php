<header class="bg-blue-900 text-white p-4">
    <div class="container mx-auto flex justify-between items-center">
        ...
        <nav class="hidden md:flex items-center space-x-4">
            ...
            <a href="{{ url("/jobs/create") }}"
                class="bg-yellow-500 hover:bg-yellow-600 text-black px-4 py-2 rounded hover:shadow-md transition duration-300 {{ request()->is('jobs/create') ? 'text-black-500 font-bold' : '' }}">
    ...
    <nav id="mobile-menu" class="hidden md:hidden bg-blue-900 text-white mt-5 pb-4 space-y-2">
        ...
        <a href="{{ url("/regitser") }}" class="block px-4 py-2 hover:bg-blue-700">Register</a>
